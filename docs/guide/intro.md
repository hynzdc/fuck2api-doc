...
**Fuck2API** 是 **FuckLab 内部实验室** 的 AI 模型统一接入服务。  
面向实验室内部研发与实验场景，用 **一套 OpenAI 兼容接口** 统一接入 GPT、Claude、Gemini 等模型能力，并提供稳定网关、智能路由与完善文档。

::: tip 使用范围
本服务仅供 **FuckLab 内部** 使用，请勿对外分享接口地址、密钥或文档。
:::
...
3. [CC-Switch 配置](/guide/cc-switch) 或手动 [Claude Code](/guide/cli/claude-code) / [Codex](/guide/cli/codex) / [Gemini](/guide/cli/gemini)
